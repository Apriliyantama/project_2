            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="max-w-md mx-auto" method="post" action="{{ route('dokter.update', $dokter->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="relative z-0 w-full mb-5 group">
                                <input type="text" name="nama" id="nama" value="{{ $dokter->nama }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                <input type="text" name="spesialisasi" id="spesialisasi" value="{{ $dokter->spesialisasi }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div class="row justify-center">
            <div class="w-full lg:w-8/12">
                ...
                <div class="card bg-white p-6 rounded-lg shadow-md">
                    <div class="card-body">
                        <h5 class="card-title text-xl font-semibold mb-4">Edit Data Dokter</h5>
                        ...
                        <form class="max-w-md mx-auto" method="post" action="{{ route('dokter.update', $dokter->id) }}" autocomplete="off">
                            @csrf
                            @method('PUT')
                            <div class="relative z-0 w-full mb-5 group">
                                <input type="text" name="nama" id="nama" value="{{ $dokter->nama }}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
