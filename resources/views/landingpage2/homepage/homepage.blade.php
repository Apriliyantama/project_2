...
<body>
    ...
    <section id="home" class="home">
        ...
        <div class="btn">
            <a class="green" href="/login/petowner">Login</a>
            <a class="lgreen" href="/register/petowner">Daftar</a>
        </div>
    </section>
    ...
    {{-- <section id="about" class="about">
        <div class="text">
            ...
            <p>Pelayanan yang tersedia pada HealthyPet</p>
            <div class="container">
                <div class=card">
                    <div class="card-content">
                        <i class="fa-solid fa-shield-dog"></i>
                        <h3>Pemeriksaan</h3>
                        <p>Pemeriksaan dan pengecekan
                            kondisi hewan
                        </p>
                    </div>
                </div>
                <div class=card">
                    <div class="card-content">
                        ...
                        <h3>Perawatan</h3>
                        <p>Perawatan Lanjutan Kesehatan
                            hewan
                        </p>
                    </div>
                </div>
                <div class=card">
                    <div class="card-content">
                        ...
                        <h3>Konsultasi</h3>
                        <p>Konsultasi dengan dokter hewan
                        </p>
                    </div>
                </div>
            </div>
